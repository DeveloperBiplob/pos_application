    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-800 small">{{ Str::ucfirst(Auth::user()->name) }}</span>
                    ...
                    <ul class="navbar-nav">
                      <li class="nav-item">
                        <form action="{{ route('logout') }}" method="POST">
                          @csrf
                          <button style="margin-top: 10px" class="btn btn-primary btn-sm ml-5" onclick=" return confirm('Are you to logout this Dashboard!')">Logout</button>
                        </form>
                      </li>
                    </ul>
                    @endauth
